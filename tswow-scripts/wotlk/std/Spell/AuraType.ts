...
export class AuraType extends EnumCellTransform<SpellEffect> {
    ...
    /** Enum value:                                               322 */
    get ModSpellChargeDef()                         { return this.value(322, x=>new ModSpellChargeDef(x)) }
    /** Enum value:                                               322 */
    get MOD_SPELL_CHARGES()                         { return this.value(322, x=>new ModSpellChargeDef(x)) }
    /** Enum value:                                               323 */
