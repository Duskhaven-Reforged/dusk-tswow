...
function syncSpellDBCRow(spell: Spell, parent: number) {
    ...
    const row = spell.row;
    const effect0 = spell.Effects.get(0);
    const effect1 = spell.Effects.get(1);
    const effect2 = spell.Effects.get(2);
    sqlRow.Category.set(row.Category.get())
        ...
        .Effect1.set(effect0.Type.get())
        .Effect2.set(effect1.Type.get())
        .Effect3.set(effect2.Type.get())
        .EffectDieSides1.set(effect0.PointsDieSides.get())
        .EffectDieSides2.set(effect1.PointsDieSides.get())
        .EffectDieSides3.set(effect2.PointsDieSides.get())
        .EffectRealPointsPerLevel1.set(effect0.PointsPerLevel.get())
        .EffectRealPointsPerLevel2.set(effect1.PointsPerLevel.get())
        .EffectRealPointsPerLevel3.set(effect2.PointsPerLevel.get())
        .EffectBasePoints1.set(effect0.PointsBase.get())
        .EffectBasePoints2.set(effect1.PointsBase.get())
        .EffectBasePoints3.set(effect2.PointsBase.get())
        .EffectMechanic1.set(effect0.Mechanic.get())
        .EffectMechanic2.set(effect1.Mechanic.get())
        .EffectMechanic3.set(effect2.Mechanic.get())
        .EffectImplicitTargetA1.set(effect0.ImplicitTargetA.get())
        .EffectImplicitTargetA2.set(effect1.ImplicitTargetA.get())
        .EffectImplicitTargetA3.set(effect2.ImplicitTargetA.get())
        .EffectImplicitTargetB1.set(effect0.ImplicitTargetB.get())
        .EffectImplicitTargetB2.set(effect1.ImplicitTargetB.get())
        .EffectImplicitTargetB3.set(effect2.ImplicitTargetB.get())
        .EffectRadiusIndex1.set(effect0.Radius.get())
        .EffectRadiusIndex2.set(effect1.Radius.get())
        .EffectRadiusIndex3.set(effect2.Radius.get())
        .EffectApplyAuraName1.set(effect0.Aura.get())
        .EffectApplyAuraName2.set(effect1.Aura.get())
        .EffectApplyAuraName3.set(effect2.Aura.get())
        .EffectAmplitude1.set(effect0.AuraPeriod.get())
        .EffectAmplitude2.set(effect1.AuraPeriod.get())
        .EffectAmplitude3.set(effect2.AuraPeriod.get())
        .EffectMultipleValue1.set(effect0.MultipleValue.get())
        .EffectMultipleValue2.set(effect1.MultipleValue.get())
        .EffectMultipleValue3.set(effect2.MultipleValue.get())
        .EffectItemType1.set(effect0.ItemType.get())
        .EffectItemType2.set(effect1.ItemType.get())
        .EffectItemType3.set(effect2.ItemType.get())
        .EffectMiscValue1.set(effect0.MiscValueA.get())
        .EffectMiscValue2.set(effect1.MiscValueA.get())
        .EffectMiscValue3.set(effect2.MiscValueA.get())
        .EffectMiscValueB1.set(effect0.MiscValueB.get())
        .EffectMiscValueB2.set(effect1.MiscValueB.get())
        .EffectMiscValueB3.set(effect2.MiscValueB.get())
        .EffectTriggerSpell1.set(effect0.TriggerSpell.get())
        .EffectTriggerSpell2.set(effect1.TriggerSpell.get())
        .EffectTriggerSpell3.set(effect2.TriggerSpell.get())
        .EffectSpellClassMaskA1.set(effect0.ClassMask.A.get())
        .EffectSpellClassMaskA2.set(effect1.ClassMask.A.get())
        .EffectSpellClassMaskA3.set(effect2.ClassMask.A.get())
        .EffectSpellClassMaskB1.set(effect0.ClassMask.B.get())
        .EffectSpellClassMaskB2.set(effect1.ClassMask.B.get())
        .EffectSpellClassMaskB3.set(effect2.ClassMask.B.get())
        .EffectSpellClassMaskC1.set(effect0.ClassMask.C.get())
        .EffectSpellClassMaskC2.set(effect1.ClassMask.C.get())
        .EffectSpellClassMaskC3.set(effect2.ClassMask.C.get())
        .DmgMultiplier1.set(effect0.BonusMultiplier.get())
        .DmgMultiplier2.set(effect1.BonusMultiplier.get())
        .DmgMultiplier3.set(effect2.BonusMultiplier.get())
