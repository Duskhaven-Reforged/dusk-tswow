...
import { SQL_dbc_spellcasttimes } from './sql/dbc_spellcasttimes'
import { SQL_dbc_spellduration } from './sql/dbc_spellduration'
...
import { SQL_jump_charge_params } from './sql/jump_charge_params'
...
import { SQL_map_dbc } from './sql/map_dbc'
...
import { SQL_spell_charge_def } from './sql/spell_charge_def'
import { SQL_spell_custom_attr } from './sql/spell_custom_attr'
import { SQL_spell_dbc } from './sql/spell_dbc'
import { SQL_spell_effects } from './sql/spell_effects'
...
import { SQL_talent_dependence } from './sql/talent_dependence'
...
export const SQL = {
    ...
    /**
     * SQL table of DBC data. Populating this table makes the server load SpellCastTimes rows from SQL.
     */
    dbc_spellcasttimes : SQL_dbc_spellcasttimes,

    /**
     * SQL table of DBC data. Populating this table makes the server load SpellDuration rows from SQL.
     */
    dbc_spellduration : SQL_dbc_spellduration,
     ...
     * No comment (yet!)
     */
    jump_charge_params : SQL_jump_charge_params,
    ...
    /**
     * Spell charge definitions.
     */
    spell_charge_def : SQL_spell_charge_def,
    ...
    /**
     * Sidecar spell effect data keyed by SpellID and EffectIndex.
     */
    spell_effects : SQL_spell_effects,
